...
//The Nested function can access the variable internal because it is a closure. Nested Function doesn't have it so it looks up to the outer scope into myFunction and grabs internal variable.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
   const mapArray = zooAnimals.map(item => `${item.animal_name}`.toLowerCase())
   return mapArray
  }
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    const filterArray = zooAnimals.filter(item => `${item.population}` < 5)
    return filterArray
  }
  ...
  */
  ...
  function USApop(zooAnimals){
    const animalTotal = zooAnimals.reduce((accumulator, item) =>{
...
// console.log(CubeMaker.volume(20,20,20))
